...
exports.handler = async (event) => {
  ...
  // Bootstrap from zero on the very first webhook; otherwise load existing state
  ...
  console.log(`Updated: ${leaderboardName ?? '(anonymous)'} +${points} pts, total packs: ${state.packsSold}`);
